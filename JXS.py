...
def menu():
    ...
    print 'AUTHOR   : JISHAN X SABIHA'

    print 'FACEBOOK : JISHAN AHAMMED'

    print 'GITHUB     : github.com/JISHAN76'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[JXS-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[JXS-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
